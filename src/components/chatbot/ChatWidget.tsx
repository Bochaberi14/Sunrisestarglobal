  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 flex h-12 w-12 items-center justify-center rounded-full bg-accent text-white shadow-lg hover:scale-110 transition-transform"
      ...
      {/* Chat Panel *}
      {open && (
        <div className="fixed bottom-20 right-6 w-80 rounded-2xl border border-slate-200 bg-white shadow-xl flex flex-col">
          <div className="border-b px-4 py-3 font-medium text-primary">
            FAQ Assistant
          </div>
