...
export default function Philosophy() {
  return (
    <section id="philosophy" className="py-16 sm:py-20 lg:py-24 bg-gray-50 overflow-x-hidden">
      ...
      <div className="mx-auto max-w-7xl bg-white rounded-3xl shadow-lg p-12">
        <Container>
          ...
          <p
            className="mt-8 sm:mt-10 text-center text-black font-semibold text-lg sm:text-xl md:text-2xl italic tracking-wide"
