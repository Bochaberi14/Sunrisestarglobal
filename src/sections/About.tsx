...
export default function About() {
  return (
    <section id="about" className="py-20 bg-white overflow-x-hidden">
      <Container>
        {/* Card wrapper */}
        <div className="bg-gray-100 rounded-2xl shadow-lg p-6 sm:p-8 lg:p-16 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
            <div className="flex items-center gap-3 mb-4 justify-center lg:justify-start">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary">ABOUT US</h2>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <img
              ...
              className="rounded-xl shadow-xl w-full max-w-[320px] lg:max-w-[280px] object-cover"
            />
          </div>
